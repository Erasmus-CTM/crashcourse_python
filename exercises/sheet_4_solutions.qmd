...
fig, ax = plt.subplots()
ax.semilogy(range(1, len(newton_errors) + 1), newton_errors, label="Newton")
ax.semilogy(range(1, len(bisection_errors) + 1), bisection_errors, label="Bisection")
ax.set_xlabel("Iteration")
ax.set_ylabel(r"$|x_{n+1} - x_n|$")
...
<nav class="bottom-page-nav" aria-label="Page navigation">
  <a class="page-nav-link prev" href="sheet_3_solutions.html">Previous: Sheet 3 Solutions</a>
  <a class="page-nav-link next" href="sheet_5_solutions.html">Next: Sheet 5 Solutions</a>
</nav>
