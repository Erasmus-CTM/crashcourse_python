...
## How to compute and visualize sequences and sums
...
<nav class="bottom-page-nav" aria-label="Page navigation">
  <a class="page-nav-link prev" href="appendix_a1.html">Previous: A.1 Introduction</a>
  <a class="page-nav-link next" href="appendix_a3.html">Next: A.3 Control Statements</a>
</nav>
